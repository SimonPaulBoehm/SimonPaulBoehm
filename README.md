...
[![Portfolio](https://img.shields.io/badge/Portfolio-000000?style=for-the-badge&&logoColor=64FFDA)]([https://SimonPaulBoehm.github.io/Portfolio/](https://portfolio-simonpaulboehms-projects.vercel.app))
...
```typescript
const simon = {
  location:   "Vienna/St. Pölten, Austria 🇦🇹",
  role:       "Full-Stack Engineer",
  focus:      ["Developer Experience", "Performance", "Clean APIs"],
  learning:   "new ways to improve",
  openTo:     "Interesting open source collaborations and job offers",
  funFact:    "music makes life more enjoyable",
};
```
